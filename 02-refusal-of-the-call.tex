...
``The wells are still operating, and open for industrial uses.  We just can't use them to get drinking water.  Some sort of poison, ap\-pa\-rent\-ly.''---Tarn sighed---``I disagreed with the king's planned course of action, and in exchange he strongarmed me into journeying to Silverdale.''
...
Tarn glanced up at the inscription on the wall, imploring him to `be true' and `shine'.  All he could think was that he was a dwarf, a guard, and not an adventurer, and that if he were being true to himself he'd hop right off that cart and get back to work.  
...
``Trust me, it's much better than the grass or the dirt'' came Law\-rence's reply.
